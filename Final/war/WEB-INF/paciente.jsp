		...
		<div class="entrada">
			<div class="tituloEntrada">NUEVO PACIENTE</div>
				<div class="cuerpoEntrada">
					<form action='regPaciente' class='receta' method='get' >
						...
						<span class='lf'>Apellido Materno: </span><input required type='text' name='apellidoMat' pattern="[a-zA-Z]+(\s)*[a-zA-Z]*"><br/>
						...
						<span class='lf'>Direccion: </span><input  required type='text' name='direccion'><br/>	
