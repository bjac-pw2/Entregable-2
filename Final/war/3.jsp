		...
		<div id="menuCenter">
			<div id="nav">
				<ul>
					...
					<li><a href="#">VENTAJAS Y DESVENTAJAS</a></li>
	...
	<div id="b">
		<div id="articulos">
			<div id="articulosDiarios">
				<h3>VENTAJAS</h3>
				<hr>
				<h5>Para el Paciente</h5>
				<p>-El paciente ya no esperara  a que una operadora responda su llamada y programe su cita. Ahora usted podrá ingresar a bjac-pw2 y podrá sacar una cita en cuestión de minutos.</p>
				<p>-Contará con toda la información que usted necesite (visualización de su historial médico).</p>
			

				<h5>Para el Medico</h5>

<p>El médico tendrá total control de sus citas.</p>
<p>Dispondrá de la información necesaria para tratar al paciente.</p>
<p>Contará con la información de los medicamentos con los que cuenta la clínica.</p>
<p>Exámenes y recetas más cómodas y sencillas de llenar.</p>
<h5>Para el Administrador</h5>
<p>Control total de los datos de la Clínica Última Esperanza.</p>
			...
			<div id="articulosDiarios">
				...
				<hr>
				<h5>General</h5>
				<p>Poca interacción con el paciente </p>
 			</div>
		</div>
	</div>
	</div>
